...
if __name__=='__main__':
    ...
    pcd = pylas.read('/Users/mathiasmoen/Skole/semester7/3Dmodelling/TBA4256_3D_Digital_modellering/Assignment1/assignment1_Data18.las')
    ...
    while pcd.header.point_count > count_threshold:
        ...
        new_file.write(r"files/BM1{}.las".format(i))
